...
module.exports = function (id, wrapper) {
    ...
    function superFlatten(args) {
        var prototype = Object.getPrototypeOf(args)
    ...
    self.request = function (method, args) {
        var scrub = scrubber.scrub(superFlatten(args));
    ...
    self.handle = function (req) {
        ...
        if (req.method === 'methods') {
            ...
            console.dir(self.localStore.get(req.method).toString())
            console.dir(self.instance)
            console.dir(args) 
